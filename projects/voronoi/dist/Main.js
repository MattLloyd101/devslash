  ...
  var randomRange = function (min) {
      return function (max) {
          return function __do() {
              ...
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(_19 * (max - min) + min)();
          };
      };
  };
...
(function(exports) {
  ...
  var pointWithin = function (area) {
      return function __do() {
          var _1 = Control_Monad_Eff_Random.randomRange(area.x)(area.x + area.w)();
          var _0 = Control_Monad_Eff_Random.randomRange(area.y)(area.y + area.h)();
  ...
  var update = function (_8) {
      return function __do() {
          var _2 = Data_Array.replicateM(Control_Monad_Eff.monadEff)(100)(pointWithin({
              x: 0.0, 
              y: 0.0, 
              w: _8.w, 
              h: _8.h
          ...
          return (function () {
              ...
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(circles);
          })()();
      };
  };
      ...
      return function (circles) {
          return function __do() {
              ...
              return Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(function (a) {
                  return Graphics_Canvas.fillPath(ctx)(Graphics_Canvas.arc(ctx)(a));
              })(circles)();
          };
      };
  };
  var render = function (canvas) {
      return function (canvasDims) {
          return function (circles) {
              return function __do() {
                  var _3 = Graphics_Canvas.getContext2D(canvas)();
                  Graphics_Canvas.clearRect(_3)(canvasDims)();
                  return drawCircles(_3)(circles)();
              };
          };
      };
  };
  var updateLoop = function (canvas) {
      return function __do() {
          var _6 = Graphics_Canvas.getCanvasWidth(canvas)();
          var _5 = Graphics_Canvas.getCanvasHeight(canvas)();
          return (function () {
              var canvasDims = {
                  x: 0.0, 
                  y: 0.0, 
              ...
              return function __do() {
                  var _4 = update(canvasDims)();
                  render(canvas)(canvasDims)(_4)();
                  return DOM_RequestAnimationFrame.requestAnimationFrame(updateLoop(canvas))();
              };
          })()();
      };
  };
  var main = function __do() {
      ...
      return (function () {
          ...
          if (_7 instanceof Data_Maybe.Just) {
              return DOM_RequestAnimationFrame.requestAnimationFrame(updateLoop(_7.value0));
          };
          throw new Error("Failed pattern match at Main line 57, column 1 - line 61, column 55: " + [ _7.constructor.name ]);
      })()();
  };
  exports["main"] = main;
